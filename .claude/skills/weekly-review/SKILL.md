...
6. 헬스: 인덱스·백업·노트 수 보고. **T1 크기**(`recent.md`+`open-loops.md` 바이트, 상한 open-loops 6KB) + `_index` 총용량 + `_index/work/` 잔여 개수 함께 보고. **삭제하지 않는다** — 설계노트 §10 임계(`_index`>200MB 또는 `work/`>50개) 초과 시에만 사용자에게 정리를 제안.
